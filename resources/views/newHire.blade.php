...
<ul>
    ...
    <p><div class="subHeader">Company</div></p>
    ...
    <p><div class="subHeader">Payroll</div></p>
    ...
    <li>
        <div>
            ...
            <span class="left">
                ...
                <input type="text" class="inputRender" name="managerEmail" id="managerEmail" required="" value="rafael.gil@illy.com">
            </span>
            <p>&nbsp;</p>
        </div>
    </li>
    ...
    <li>
        <div class="left">
            Start Date
            <input type="text" class="inputRender" name="startDate" id="startDate" readonly style="width: 100px" required="" value="05/14/2015">
    ...
    <ul>
        <li>
            ...
            <p style="text-align: center">
                ...
                <input type="text" class="inputRender" name="payrollDate" id="payrollDate" readonly style="width: 100px" required="" value="05/14/2015">
        ...
        <li>
            ...
            <div class="left3">
                ...
                <select name="salesLevel" id="salesLevel" class="inputRender">
                    ...
                    <option value="Level III Regional / Division Sales Manager / <br> National Retail Managers / Systems Mgr">Level III</option>
...
<span class="checkbox">
        <ul id="itCheckList">
            <li id="prepareLaptop"><label><input type="checkbox" class="inputRender" name="iTDept[]" id="laptop" value="Laptop">Laptop/Computer</label></li>


            <p>Standard notification request includes on all computers/laptops: OfficeSuite, Adobe Acrobat Pro, CCleaner, VPN, Efax, Chrome, Firefox, Silverlight, FlashPlayer, Omniform, Skype, Dropbox, VLC Media Player, 7Zip. Outlook, Addition to distributions lists.</p>
            <p> All Cellphones will include a link to Hotspot set up.</p>
            <p> *Upon user notification request, IT provides customer service to hiring manager and new hire. Hiring managers will be contacted before new hire begins.</p>
            <p></p>
            ...
            <li><label><input type="checkbox" class="inputRender" name="iTDeptEmail[]" id="illynycteam" value="illyusa NYC Team"> illyusa NYC Team</label></li>
            ...
            <p></p>
            <p></p>
            <li><label><input type="checkbox" class="inputRender" name="iTDept[]" id="cellphone" value="Cell Phone (Samsung Galaxy) <br>*Cell phone number and company, will be updated in outlook upon receipt."> Cell Phone (Samsung Galaxy) <br>*Cell phone number and company, will be updated in outlook upon receipt.</label></li>
            <li><label><input type="checkbox" class="inputRender" name="iTDept[]" id="phone" value="Phone extension"> Phone extension/Voice mail</label></li>
            <li><label><input type="checkbox" class="inputRender" name="iTDept[]" id="fax" value="Fax number"> Fax number</label></li>
...
<br>
        <div class="subHeader">Specific assets and or functionalities needed: not listed on the User Notification form should be confirmed with hiring manager by IT.
            <p></p>
            SPECIFIC INSTRUCTIONS HERE:<P></P></div>
<div class="subHeader">IT Oracle Specialist</div>
<label>
    <input type="checkbox" class="inputRender" name="oracle" id="oracle" value="Oracle Access/Oracle (HR) Number Approval (Sales, Finance, Logistics, Customer Care, IT, Tech Svcs)" checked> Oracle Access/Oracle (HR) Number Approval (Sales, Finance, Logistics, Customer Care, IT, Tech Svcs)</label>
...
<div class="subHeader">Administration Office</div>
    ...
    <ul>
        <li>
            <label><input type="checkbox" class="inputRender" name="oManager[]" id="accessCard" value="Access Card, if applicable" checked> Access Card, if applicable</label>
        </li>
        <li>
        ...
        <li>
            <label><input type="checkbox" class="inputRender" name="oManager[]" id="businessCard" value="Business Cards"> Business Cards, if need to ship to outside location please contact hiring manager for address</label>
        </li>
        <li>
...
<p></p>
    <div class="subHeader">New Driver for Company Vehicle Form-Erik Tellone (new hire notification only) (if applicable)</div>

        <label><input type="checkbox" class="inputRender" name="newDriver" id="newDriver" value="Form to Hiring Manager" checked> Form to Hiring Manager</label>
    <p></p>
    <div class="subHeader">COMPANY CREDIT CARD-Marjorie Guthrie (if applicable)-included in new hires and separation notices</div>
    <ul>
        <li>
            <label><input type="checkbox" class="inputRender" name="creditCard[]" id="creditCard" value="COMPANY CREDIT CARD" checked> COMPANY CREDIT CARD</label>
        </li>
        <li>
            <label><input type="checkbox" class="inputRender" name="creditCard[]" id="concur" value="Concur Access"> Concur Access</label>
        </li>
    </ul>
